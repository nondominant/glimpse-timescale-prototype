...
cbwTurnsTable.belongsTo(assetTable, {as: "assetKey"});

//assetTable.hasMany(eventSourceTable );
eventSourceTable.belongsTo(assetTable, {as: "assetKey"});

//eventSourceTable.hasMany(sensorEventTable);
sensorEventTable.belongsTo(eventSourceTable, {as: "eventSourceID"});

//assetTable.hasMany(sensorEventTable);
sensorEventTable.belongsTo(assetTable, {as: "assetKey"});

//employeeTable.hasMany(sensorEventTable);
sensorEventTable.belongsTo(employeeTable, {as: "employeeID"});

//productTable.hasMany(sensorEventTable);
sensorEventTable.belongsTo(productTable, {as: "productID"});

//assetTable.hasMany(machineStatusTable);
machineStatusTable.belongsTo(assetTable, {as: "assetKey"});

//productTable.hasMany(machineStatusTable);
machineStatusTable.belongsTo(productTable, {as: "productID"});

//meterTable.hasMany(resourceUsageTable, );
resourceUsageTable.belongsTo(meterTable, {as: "meterID"});

//assetTable.hasMany(resourceUsageTable);
resourceUsageTable.belongsTo(assetTable, {as: "assetKey"});

//employeeTable.hasMany(locationTable);
locationTable.belongsTo(employeeTable, {as: "employeeID"});

//assetTable.hasMany(locationTable);
locationTable.belongsTo(assetTable, {as: "assetKey"});

//productTable.hasMany(locationTable);
locationTable.belongsTo(productTable,{as: "productID"});
